...
export const AdminDashboardTab: React.FC<AdminDashboardTabProps> = ({
  ...
  const statCards = [
    ...
    {
      id: 'deposit_complaints',
      label: 'Deposit Disputes & Problems',
      value: stats?.pendingComplaintsCount || 0,
      subValue: `${stats?.pendingComplaintsCount || 0} disputes pending review`,
      icon: AlertCircle,
      color: 'from-rose-500/20 to-rose-600/10 border-rose-500/30 text-rose-400',
      actionTab: 'complaints',
      highlightBadge: stats && stats.pendingComplaintsCount && stats.pendingComplaintsCount > 0 ? `${stats.pendingComplaintsCount} PENDING REVIEW` : undefined,
    },
    {
