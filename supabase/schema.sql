...
-- 2.23 REFERRAL COMMISSION SETTLEMENTS TABLE
...
-- 5.3.2 ATOMIC REFERRAL COMMISSION SETTLEMENT RPC
DROP FUNCTION IF EXISTS public.settle_referral_commission CASCADE;
...
GRANT EXECUTE ON FUNCTION public.settle_referral_commission TO anon, authenticated, service_role;
